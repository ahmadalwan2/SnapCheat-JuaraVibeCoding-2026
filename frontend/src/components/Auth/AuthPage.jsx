...
const AuthPageContent = ({ type, setType, onBack, onLoginSuccess }) => {
  ...
  return (
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 relative z-10 w-full mt-10 md:mt-0">
        ...
        <div className="flex items-center gap-2 mb-6">
          <img src="/Snapcheat-logo.svg" alt="SnapCheat" className="h-7 w-7 object-contain" />
          <span className="text-2xl font-bold font-heading tracking-tight text-[#171717]">
            Snap<span className="text-[#2FA084]">Cheat</span>
          </span>
        </div>

        <div className="bg-white/80 backdrop-blur-xl w-full max-w-[420px] rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-white p-8 md:p-10">
          
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-[#171717] font-heading mb-2">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {type === 'register' && (
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-white border border-[#eaeaea] rounded-2xl text-sm text-[#171717] placeholder-[#a3a3a3] focus:outline-none focus:border-[#2FA084] focus:ring-1 focus:ring-[#2FA084] transition-all" 
            ...
            <button type="submit" disabled={isLoading} className="w-full py-3 px-4 mt-2 rounded-2xl shadow-sm text-sm font-semibold text-white bg-[#2FA084] hover:bg-[#258069] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2FA084] disabled:opacity-50 transition-colors cursor-pointer">
            ...
            <button onClick={() => loginWithGoogle()} type="button" disabled={isLoading} className="w-full flex items-center justify-center gap-2 py-3 px-4 border border-[#eaeaea] rounded-2xl bg-white text-sm font-medium text-[#171717] hover:bg-[#fafafa] transition-colors cursor-pointer disabled:opacity-50">
